...
public class RentalServiceImpl implements RentalService {
   ...
   */
  @Override
  public void createRental(RentalCreateRequestDto rentalCreateRequestDto, Integer userId) {
   ...
   */
  @Override
  public void updateRental(Integer rentalId, RentalUpdateRequestDto rentalUpdateRequestDto, Integer userId) {
   ...
   */
  @Override
  public List<RentalListResponseDto> findAllRentals() {
    Iterable<RentalEntity> rentals = rentalRepository.findAll();

    List<RentalListResponseDto> rentalDtos = new ArrayList<>();
   ...
   */
  @Override
  public RentalDetailResponseDto findRentalById(Integer rentalId) {

    RentalEntity rental = rentalRepository.findById(rentalId)
        .orElseThrow(() -> new ResourceNotFoundException("Rental not found: " + rentalId));

    RentalDetailResponseDto rentalDto = new RentalDetailResponseDto();
    rentalDto.setId(rental.getId());
    rentalDto.setName(rental.getName());
    rentalDto.setSurface(rental.getSurface());
    rentalDto.setPrice(rental.getPrice());
    rentalDto.setPicture(rental.getPicture() != null ? List.of(rental.getPicture()) : List.of());
